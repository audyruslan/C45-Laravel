...
<body>
    ...
    <header id="header" class="header fixed-top">
        <div class="container-fluid container d-flex  justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                ...
                <nav class="navbar bg-light" aria-label="Light offcanvas navbar">
                    ...
                    <div class=" offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbarLight" aria-labelledby="offcanvasNavbarLightLabel">
                        ...
                        <h5 class="offcanvas-lg-1 offcanvas-title" id="offcanvasNavbarLightLabel">Aministrator Menu</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                        </div>
                        <div class="offcanvas-body">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Data Training</a>
                            </li>
            ...
            <a href="/admin" class=" logo d-flex align-items-left">
